...
rm(list=ls())
Dive <- read.csv("DiveDataset.csv", fileEncoding="UTF-8-BOM")
head(Dive)

#Split dataset By Site
MO2 <- Dive[c(5164:15272,22846:31998),c(1:23)]
HC2 <- Dive[c(2:5163,15273:22845),c(1:23)]

#Split dataset by Year
both2019 <- Dive[c(2:15271),c(1:23)]
both2020 <- Dive[c(15272:31998),c(1:23)]
...
Tawa <- read.csv("DiveDataset.csv", fileEncoding="UTF-8-BOM")
head(Tawa)

both2019 <- Tawa[c(2:15271),c(1:23)]
both2020 <- Tawa[c(15272:31998),c(1:23)]
